...
const MONZA_GRID: SimDriverSeed[] = [
  ...
  { number: 20, code: 'MAG', name: 'Kevin Magnussen', team: 'Haas', color: '#B6BABD', startPos: 13, endPos: 10, stint1Compound: 'MEDIUM', pitLap: 20, stint2Compound: 'HARD' },
  ...
  { number: 3, code: 'RIC', name: 'Daniel Ricciardo', team: 'RB', color: '#6692FF', startPos: 12, endPos: 13, stint1Compound: 'MEDIUM', pitLap: 11, stint2Compound: 'HARD' },
  ...
  { number: 27, code: 'HUL', name: 'Nico Hulkenberg', team: 'Haas', color: '#B6BABD', startPos: 10, endPos: 17, stint1Compound: 'MEDIUM', pitLap: 5, stint2Compound: 'HARD', pitLap2: 33, stint3Compound: 'HARD' },
...
export function useRaceSimulation(initialSnapshot: LiveSnapshot | null) {
  ...
  const [simSpeed, setSimSpeed] = useState<number>(1); // 1 = 2.5s per lap, 2 = 1.2s, 5 = 0.5s
  ...
  }, [isSimulating, simLap, totalLaps, initialSnapshot, simBaseTimestamp]);
