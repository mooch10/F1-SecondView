    ...
    graduatesToF1: [
      {
        ...
        yearGraduated: 2026,
        f2Result: 'Líder F2 2026 (4 victorias)',
        notes: 'Protegido de Fernando Alonso y Red Bull Junior Team, encabezando la clasificación de F2.',
        notesEn: 'Fernando Alonso and Red Bull Junior Team protégé leading the F2 standings.',
        currentRole: 'Red Bull Junior • Candidato F1',
        flag: '🇧🇬',
      },
      {
        name: 'Rafael Câmara',
        ...
        yearGraduated: 2026,
        f2Result: 'P2 F2 (3 victorias)',
        notes: 'Vigente campeón de F3 y figura de Ferrari Driver Academy en cerrada batalla por el título.',
        notesEn: 'Reigning F3 Champion and Ferrari Driver Academy star locked in title fight.',
        currentRole: 'Ferrari Junior • Candidato F1',
        flag: '🇧🇷',
      },
      {
        name: 'Alex Dunne',
        code: 'DUN',
        f2Team: 'Rodin Motorsport',
        f1Team: 'Alpine Academy',
        yearGraduated: 2026,
        f2Result: 'P3 F2 (2 victorias)',
        notes: 'Piloto irlandés estrella de la Alpine Academy, una de las grandes revelaciones de la temporada.',
        notesEn: 'Irish standout from the Alpine Academy, among the season\'s biggest breakout stars.',
        currentRole: 'Alpine Junior • Candidato F1',
        flag: '🇮🇪',
      },
      {
        name: 'Gabriele Minì',
        ...
        yearGraduated: 2026,
        f2Result: 'P4 F2 / Reserva F1',
        notes: 'Subcampeón de F3 y F2, acumulando valiosa experiencia como piloto de pruebas de Alpine.',
        notesEn: 'F3 and F2 runner-up accumulating valuable test mileage with Alpine F1.',
        currentRole: 'Piloto Reserva Alpine F1',
        flag: '🇮🇹',
      },
      {
        name: 'Dino Beganovic',
        code: 'BEG',
        f2Team: 'DAMS Lucas Oil',
        f1Team: 'Ferrari Driver Academy',
        yearGraduated: 2026,
        f2Result: 'Top 6 F2',
        notes: 'Piloto sueco de la Ferrari Driver Academy sumando podios de forma regular en F2.',
        notesEn: 'Swedish Ferrari Driver Academy protégé scoring regular podiums in F2.',
      ...
      },
      {
        ...
        yearGraduated: 2026,
        f2Result: 'Top 8 F2',
        notes: 'Talento del Red Bull Junior Team con destacadas actuaciones en carreras de F2.',
        notesEn: 'Red Bull Junior Team talent delivering strong drives in Formula 2 races.',
  ...
  },
  {
    ...
    graduatesToF1: [
      ...
      },
      {
        ...
        f1Team: 'Kick Sauber F1 Team',
        yearGraduated: 2024,
        f2Result: 'Campeón F2',
        notes: 'Campeón tras tres temporadas de regularidad de élite, piloto de pruebas y reserva oficial.',
        notesEn: 'Champion after 3 seasons of elite consistency, official test and reserve driver.',
        currentRole: 'Piloto Reserva F1 / Super Formula',
        flag: '🇫🇷',
      },
      {
        name: 'Frederik Vesti',
        code: 'VES',
        f2Team: 'PREMA Racing',
        f1Team: 'Mercedes-AMG F1 Team',
        yearGraduated: 2024,
        f2Result: 'Subcampeón F2 (6 victorias)',
        notes: 'Subcampeón con más victorias en la temporada, ascendido a piloto reserva de Mercedes.',
        notesEn: 'Runner-up with most wins of the season, promoted to Mercedes reserve driver.',
        currentRole: 'Piloto Reserva Mercedes F1',
        flag: '🇩🇰',
      },
    ],
  },
    ...
    graduatesToF1: [
      {
        ...
        code: 'DRU',
        f2Team: 'MP Motorsport',
        f1Team: 'Aston Martin F1 Team',
        yearGraduated: 2023,
        f2Result: 'Campeón F2 (5 victorias)',
        notes: 'Dominio aplastante con MP Motorsport, consagrado como piloto reserva oficial de Aston Martin.',
        notesEn: 'Crushing dominance with MP Motorsport, established as Aston Martin official reserve driver.',
        currentRole: 'Piloto Reserva Aston Martin F1',
        flag: '🇧🇷',
      },
      {
        name: 'Logan Sargeant',
    ...
    graduatesToF1: [
      {
        ...
        f1Team: 'Haas F1 Team',
        yearGraduated: 2021,
        f2Result: 'Campeón F2 (2 victorias, 10 podios)',
        notes: 'Campeón consagrado en Sakhir y ascendido directamente a la F1 con Haas.',
        notesEn: 'Crowned Champion in Sakhir and promoted directly into F1 with Haas.',
        currentRole: 'Piloto Reserva F1 / Alpine WEC',
        flag: '🇩🇪',
      },
      {
        name: 'Yuki Tsunoda',
      ...
      },
      {
        name: 'Nikita Mazepin',
        code: 'MAZ',
        f2Team: 'Hitech Grand Prix',
        f1Team: 'Haas F1 Team',
        yearGraduated: 2021,
        f2Result: '5º en F2 (2 victorias)',
        notes: 'Obtuvo los puntos de Superlicencia requeridos para debutar en F1 con Haas en 2021.',
        notesEn: 'Secured required Super License points to make F1 debut with Haas in 2021.',
        currentRole: 'Ex-Piloto F1',
        flag: '🏳️',
      },
    ],
    ...
    graduatesToF1: [
      {
        ...
        code: 'FOR',
        f2Team: 'Trident',
        f1Team: 'Invicta F2 / McLaren Driver Dev.',
        yearGraduated: 2025,
        f2Result: 'Campeón F3 2024',
        notes: 'Inmediato salto a Invicta Racing en F2 y fichado como piloto de desarrollo por McLaren F1.',
        notesEn: 'Immediate step up to Invicta Racing in F2 and signed to McLaren Driver Development.',
        currentRole: 'Campeón F2 / Reserva McLaren',
        flag: '🇮🇹',
      },
      {
        name: 'Gabriele Minì',
        code: 'MIN',
        f2Team: 'PREMA Racing',
        f1Team: 'PREMA F2 / Alpine Academy',
        yearGraduated: 2025,
        f2Result: 'Subcampeón F3',
        notes: 'Subcampeón de F3 y debut con podio en su estreno en F2 en las calles de Bakú.',
        notesEn: 'F3 runner-up with an instant podium on his F2 debut on the Baku street circuit.',
        currentRole: 'Piloto F2 / Reserva Alpine F1',
        flag: '🇮🇹',
      },
      {
        name: 'Luke Browning',
        code: 'BRO',
        f2Team: 'Hitech Pulse-Eight',
        f1Team: 'ART F2 / Williams Academy',
        yearGraduated: 2025,
        f2Result: '3º en F3 (2 victorias)',
        notes: 'Puntal de Williams Racing Driver Academy ascendido a monoplazas de F2.',
        notesEn: 'Key Williams Racing Driver Academy talent promoted to Formula 2 machinery.',
        currentRole: 'Piloto F2 / Williams Junior',
        flag: '🇬🇧',
      },
      {
        name: 'Arvid Lindblad',
        code: 'LIN',
        f2Team: 'PREMA Racing',
        f1Team: 'Campos F2 / Red Bull Junior',
        yearGraduated: 2025,
        f2Result: '4º en F3 (4 victorias)',
        notes: 'Doble victoria histórica en Silverstone en su año rookie; promovido a F2 y a la F1 2026 con Racing Bulls.',
        notesEn: 'Historic Silverstone double win in rookie year; promoted to F2 and 2026 F1 race seat with Racing Bulls.',
        currentRole: 'Piloto Titular F1 (Racing Bulls)',
        flag: '🇬🇧',
      },
      {
        name: 'Dino Beganovic',
        code: 'BEG',
        f2Team: 'PREMA Racing',
        f1Team: 'DAMS F2 / Ferrari Driver Academy',
        yearGraduated: 2025,
        f2Result: '6º en F3 (2 victorias)',
        notes: 'Piloto sueco de la Ferrari Driver Academy promovido a F2 con DAMS.',
        notesEn: 'Swedish Ferrari Driver Academy protégé promoted to F2 with DAMS.',
        currentRole: 'Piloto F2 / Ferrari Junior',
        flag: '🇸🇪',
      },
      {
        name: 'Oliver Goethe',
        code: 'GOE',
        f2Team: 'Campos Racing',
        f1Team: 'MP F2 / Red Bull Junior',
        yearGraduated: 2025,
        f2Result: '7º en F3 (1 victoria)',
        notes: 'Miembro del Red Bull Junior Team que subió a F2 con MP Motorsport.',
        notesEn: 'Red Bull Junior Team member stepping up to F2 with MP Motorsport.',
        currentRole: 'Piloto F2 / Red Bull Junior',
        flag: '🇩🇪',
      },
    ],
  },
    ...
    graduatesToF1: [
      {
        ...
        yearGraduated: 2025,
        f2Result: 'Campeón F3 (2 victorias)',
        notes: 'Dominó la temporada como novato y dio el salto para ganar la F2 2024 y llegar a la F1.',
        notesEn: 'Rookie F3 Champion who moved up to clinch the 2024 F2 title and secure an F1 seat.',
        currentRole: 'Piloto Titular F1',
        flag: '🇧🇷',
      },
      {
        ...
        f1Team: 'Williams Racing / Alpine',
        yearGraduated: 2024,
        f2Result: '4º en F3 (2 victorias, 5 podios)',
        notes: 'Campaña brillante con MP Motorsport y Williams Academy antes de su ascenso meteórico a la F1.',
        notesEn: 'Stellar campaign with MP and Williams Academy prior to his meteoric F1 ascent.',
        currentRole: 'Piloto Titular F1',
        flag: '🇦🇷',
      },
      {
        ...
        code: 'OSU',
        f2Team: 'PREMA Racing',
        f1Team: 'Williams Driver Academy',
        yearGraduated: 2024,
        f2Result: 'Subcampeón F3 (4 victorias)',
        notes: 'Subcampeón destacado de la Williams Academy con múltiples victorias.',
        notesEn: 'Outstanding Williams Academy runner-up with 4 race victories.',
        currentRole: 'Piloto F2 / Williams Junior',
        flag: '🇬🇧',
      },
      {
        ...
        code: 'ARO',
        f2Team: 'PREMA Racing',
        f1Team: 'Alpine F1 Reserve',
        yearGraduated: 2024,
        f2Result: '3º en F3 (1 victoria, 4 podios)',
        notes: 'Gran regularidad en el podio antes de su destacada campaña en F2 y rol en Alpine.',
        notesEn: 'Consistent podium finisher before his strong F2 season and Alpine role.',
        currentRole: 'Piloto Reserva F1',
        flag: '🇪🇪',
      },
      {
        ...
        f1Team: 'Red Bull Junior Team',
        yearGraduated: 2024,
        f2Result: '5º en F3 (3 victorias)',
        notes: 'Fichado por Helmut Marko tras sus victorias con Campos Racing para ascender a F2.',
        notesEn: 'Signed by Helmut Marko after memorable wins with Campos Racing to graduate to F2.',
        currentRole: 'Piloto F2 / Red Bull Junior',
        flag: '🇪🇸',
      },
    ],
    ...
    graduatesToF1: [
      {
        ...
        f1Team: 'MoneyGram Haas F1',
        yearGraduated: 2025,
        f2Result: '3º en F3 (1 victoria, 8 podios)',
        notes: 'Debut impresionante como novato en F3 que lo catapultó a F2 y a su debut estelar en F1 con Ferrari y Haas.',
        notesEn: 'Stunning rookie F3 season launching him into F2 and stellar F1 debuts with Ferrari and Haas.',
        currentRole: 'Piloto Titular F1',
        flag: '🇬🇧',
      },
      {
        ...
        yearGraduated: 2023,
        f2Result: 'Campeón F3 (2 victorias)',
        notes: 'Campeón en una de las definiciones más ajustadas de la historia antes de ser Rookie del Año en F2.',
        notesEn: 'Champion in one of the closest title deciders ever before earning F2 Rookie of the Year.',
        currentRole: 'Piloto F2 / Alpine Junior',
        flag: '🇫🇷',
      },
      {
        name: 'Zane Maloney',
        code: 'MAL',
        f2Team: 'Trident',
        f1Team: 'Sauber F1 Reserve',
        yearGraduated: 2023,
        f2Result: 'Subcampeón F3 (3 victorias)',
        notes: 'Cierre de ensueño ganando 3 carreras consecutivas antes de su paso a F2 y reserva de F1.',
        notesEn: 'Sensational finish winning 3 consecutive Feature races before stepping up to F2.',
        currentRole: 'Piloto Reserva F1',
        flag: '🇧🇧',
      },
      {
        ...
        f1Team: 'Racing Bulls / Red Bull',
        yearGraduated: 2025,
        f2Result: '4º en F3 (3 victorias)',
        notes: 'Novato estrella del Red Bull Junior Team con victorias en Bahrein, Mónaco y Spielberg.',
        notesEn: 'Star rookie of Red Bull Junior Team with wins in Bahrain, Monaco and Spielberg.',
        currentRole: 'Piloto Titular F1',
        flag: '🇫🇷',
      },
    ],
    ...
    graduatesToF1: [
      {
        ...
        yearGraduated: 2025,
        f2Result: 'Subcampeón F3 (4 victorias)',
        notes: 'Lideró a Trident al título de equipos antes de convertirse en piloto titular de Alpine F1.',
        notesEn: 'Led Trident to the team crown before ascending to a full-time Alpine F1 seat.',
        currentRole: 'Piloto Titular F1',
        flag: '🇦🇺',
      },
      {
        ...
        f1Team: 'Red Bull Junior Team',
        yearGraduated: 2022,
        f2Result: 'Campeón F3 (4 victorias, 9 podios)',
        notes: 'Dominio absoluto de la temporada con PREMA antes de dar el salto a la F2.',
        notesEn: 'Commanding championship victory with PREMA before graduating to F2.',
        currentRole: 'Piloto F2 / Indy NXT',
        flag: '🇳🇴',
      },
      {
        name: 'Frederik Vesti',
        code: 'VES',
        f2Team: 'ART Grand Prix',
        f1Team: 'Mercedes-AMG F1 Reserve',
        yearGraduated: 2022,
        f2Result: '4º en F3 (1 victoria, 5 podios)',
        notes: 'Prodigio de Mercedes Junior Team que luego fue subcampeón de F2 y reserva de F1.',
        notesEn: 'Mercedes Junior standout who later became F2 runner-up and Mercedes F1 reserve.',
        currentRole: 'Piloto Reserva Mercedes F1',
        flag: '🇩🇰',
      },
      {
        name: 'Logan Sargeant',
        code: 'SAR',
        f2Team: 'Charouz Racing System',
        f1Team: 'Williams Racing',
        yearGraduated: 2023,
        f2Result: '7º en F3 (1 victoria en Sochi)',
        notes: 'Heroica temporada con Charouz sumando una victoria que mantuvo con vida su camino a la F1.',
        notesEn: 'Heroic campaign with Charouz scoring a win that kept his F1 journey on track.',
        currentRole: 'Ex-Piloto F1',
        flag: '🇺🇸',
      },
    ],
    ...
    graduatesToF1: [
      {
        ...
        f1Team: 'McLaren F1 Team',
        yearGraduated: 2023,
        f2Result: 'Campeón F3 (2 victorias, 6 podios)',
        notes: 'Campeón como novato en Mugello en el primer escalón de su legendario ascenso a F1.',
        notesEn: 'Rookie Champion at Mugello in the opening chapter of his legendary run to F1.',
        currentRole: 'Piloto Estrella F1',
        flag: '🇦🇺',
      },
      {
        ...
        f1Team: 'Sauber F1 Reserve',
        yearGraduated: 2024,
        f2Result: 'Subcampeón F3 (2 victorias)',
        notes: 'El ganador de carreras más joven de la historia de F3 con solo 16 años, subcampeón por 3 puntos.',
        notesEn: 'Youngest race winner in F3 history at age 16, missing the title by only 3 points.',
        currentRole: 'Piloto Reserva F1 / Super Formula',
        flag: '🇫🇷',
      },
      {
        ...
        f1Team: 'Williams Racing',
        yearGraduated: 2023,
        f2Result: '3º en F3 (1 victoria, 6 podios)',
        notes: 'Peleó el título hasta la ronda final antes de llegar a la F1 con Williams.',
        notesEn: 'Title contender right down to the final round before reaching F1 with Williams.',
        currentRole: 'Ex-Piloto F1',
        flag: '🇺🇸',
      },
      {
        ...
        yearGraduated: 2023,
        f2Result: '5º en F3 (3 victorias)',
        notes: 'Piloto agresivo del Red Bull Junior Team con 3 victorias de carrera en su paso a F2 y F1.',
        notesEn: 'Aggressive Red Bull Junior talent scoring 3 race wins on his path to F2 and F1.',
        currentRole: 'Piloto Titular F1',
        flag: '🇳🇿',
      },
    ],
