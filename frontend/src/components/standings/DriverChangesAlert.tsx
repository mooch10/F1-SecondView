              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2 flex-wrap min-w-0">
                    ...
                    {/* Explanation Reason - Mobile: only when toggled; Desktop (PC): always visible */}
                    {reason && (
                      <span
                        className={`text-zinc-600 dark:text-zinc-400 text-[11px] leading-snug break-words ${
                          showDetailedBreakdown ? 'inline' : 'hidden md:inline'
                        }`}
                      >
                        ({reason})
                      </span>
