      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="bg-[#131722] border border-white/[0.08] rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="grid grid-cols-12 gap-1 px-3 py-2 bg-[#1C2230] border-b border-white/[0.08] text-[10px] font-bold tracking-wider uppercase text-zinc-400 font-mono select-none items-center">
            ...
            <div className="col-span-3 sm:col-span-3 text-right">TIEMPO / GAP</div>
          </div>
              ...
              return (
                <div key={d.driverNumber} className="flex flex-col">
                  ...
                  >
                    ...
                    {/* Driver & Team */}
                    <div
                      className="col-span-3 sm:col-span-3 flex items-center gap-1.5 sm:gap-2 overflow-hidden cursor-pointer group"
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    >
                      ...
                      <div className="flex flex-col leading-tight truncate">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {item.isPhaseLeader && (
                            <span className="px-1 py-0.2 rounded text-[8px] font-mono font-black bg-amber-500/20 text-amber-300 border border-amber-500/40">
                              {phaseFilter === 'ALL' || phaseFilter === 'Q3' ? 'POLE' : 'LÍDER'}
                            </span>
                          )}
                          {d.inPit && (
                            <span className="px-1 py-0.2 rounded text-[8px] font-mono font-bold bg-zinc-800 text-zinc-400 border border-white/10">
                              PIT
                            </span>
                          )}
                        </div>
